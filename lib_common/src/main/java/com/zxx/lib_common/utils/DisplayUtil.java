...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = ConstantUtils.getAPPContext().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = ConstantUtils.getAPPContext().getResources().getDisplayMetrics().scaledDensity;
